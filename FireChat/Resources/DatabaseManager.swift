...
//  FireChat
//
//  Created by Ritika Dhall on 02/11/20.
//
...
extension DatabaseManager {
    ...
    public func createNewConversation(with otherUserEmail: String, name: String, firstMessage: Message, completion: @escaping (Bool) -> Void) {
        ...
        ref.observeSingleEvent(of: .value, with: { [weak self] snapshot in
            ...
            if var conversations = userNode["conversations"] as? [[String: Any]] {
                ...
                // conversation array does NOT exist for current user
                // create
            ...
            let messages: [Message] = value.compactMap({ dictionary in
                ...
                if type == "photo" {
                    ...
                    guard let imageUrl = URL(string: content),
                          let placeholder = UIImage(systemName: "camera") else {
                        return nil
                    }
                    ...
                    print("Rendering loation: Long - \(longitude) | Lat - \(latitude)")
    ...
    public func conversationExists(with targetRecipientEmail: String, completion: @escaping (Result<String, Error>) -> Void) {
        let safeRecipientEmail = DatabaseManager.safeEmail(emailAddress: targetRecipientEmail)  // Joe
        guard let senderEmail = UserDefaults.standard.value(forKey: "email") as? String else {
            return
        }
        let safeSenderEmail = DatabaseManager.safeEmail(emailAddress: senderEmail)  // Rose
        ...
        database.child("\(safeRecipientEmail)/conversations").observeSingleEvent(of: .value, with: { snapshot in
            ...
            // iterate and find target conversation with target sender
